...
moduleForModel('i-i-s-my-test-application-ember-type', 'Unit | Serializer | i-i-s-my-test-application-ember-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-my-test-application-ember-type',
    'transform:file',
    'transform:decimal',
