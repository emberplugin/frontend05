...
moduleForModel('i-i-s-my-test-application-ember-computer', 'Unit | Serializer | i-i-s-my-test-application-ember-computer', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-my-test-application-ember-computer',
    'transform:file',
    'transform:decimal',
